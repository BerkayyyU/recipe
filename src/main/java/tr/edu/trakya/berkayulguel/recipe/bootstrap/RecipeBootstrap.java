package tr.edu.trakya.berkayulguel.recipe.bootstrap;

import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import tr.edu.trakya.berkayulguel.recipe.models.Difficulty;
import tr.edu.trakya.berkayulguel.recipe.models.Ingredient;
import tr.edu.trakya.berkayulguel.recipe.models.Notes;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        var mexicanCategory = categoryRepository.findByDescription("American").get();
